...
export class LoginDemoComponent implements OnInit {
    ...
    clientEmail = ['sugam.pradhan@appteam.com',  'abhijit@appteam.com', 'dharan@appteam.com'];
    conflictDetails = ['deepak.paul@appteam.com', 'abc@appteam.com', 'xyz@appteam.com'];
    ...
    ngOnInit() {
        ...
        this.storage.setItem('clientEmail', JSON.stringify(this.clientEmail));
        this.storage.setItem('conflictDetails', JSON.stringify(this.conflictDetails));
    ...
    onLogin($event) {
        // this.storage.setItem('loggedInUser', );
    ...
    validateForm(event: any) {
        ...
        this.storage.setItem('loginEmail', JSON.stringify(values.controls['username'].value));
        }
    }
